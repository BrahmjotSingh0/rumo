...
- Both the backend and the frontend send a Content-Security-Policy - see [Security notes](README.md#security-notes) for what the frontend's covers and why its `connect-src` is generated per deployment instead of hardcoded.
